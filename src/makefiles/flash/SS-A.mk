...
all: base progressive9 progressive15 progressive37 SimAnnealing9 SimAnnealing15 SimAnnealing37 bonr9 bonr15 bonr37 b29 b215 b237 rand9 rand15 rand37 ExpProgressive9 ExpProgressive15 ExpProgressive37 PI9 PI15 PI37 EI9 EI15 EI37 UCB9 UCB15 UCB37 rand1208
...
PI37:
	python3 gate.py -t PI_stats -E 37 $(ARGUMENT)
...
EI37:
	python3 gate.py -t EI_stats -E 37 $(ARGUMENT)
...
UCB37:
	python3 gate.py -t UCB_stats -E 37 $(ARGUMENT)
